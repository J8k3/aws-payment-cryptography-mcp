...
class HsmCommand:
    ...
    notes: str = ""
    confidence: str = "high"        # high, medium (reference quality source)
...
IMPLEMENTATION_STATUS = (
    "PARTIAL — Futurex Excrypt/Standard/International commands documented from authoritative source. "
    "Thales-specific key management commands (A0, A6, A8, IA, BU) from EFTlab (reference quality). "
    "Atalla commands: NOT YET AVAILABLE."
)
